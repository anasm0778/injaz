export const data = [
  {
    heading: "1. Insurance:",
    text: [
      "Full Comprehensive insurance is provided subject to current U.A.E Law. The Hirer is liable for the first AED [1500-3500] varies per car category - against claims resulting from each and every accident including (hit-and-run) reporting you at fault (as evidenced by a Police report). This can be waived by buying the super collision damage waiver (SCDW).",
    ],
  },
  {
    heading: "2. Kilometers Driven:",
    text: [
      "Kilometers are limited to 250km/day or 1400km/week or 2500-5000km/month, where additional kilometers will be chargeable @ 0.5 -5/km varies by vehicle's group and category.",
    ],
  },
  {
    heading: "3. Maintenance:",
    text: [
      "It includes routine & major servicing at a certain km/mileage, as mentioned on the sticker attached to the vehicle's windshield as per recommendations of its dealer. (Kindly refer to the same and collaborate with our fleet department on (050-3755886) (050-9961569) for the due arrangements).",
    ],
  },
  {
  ...
  },
  {
    ...
    text: [
      ...
      "Additional charges are applicable for Salik (Dubai Tollgate pass) at Dhs.5 or Dhs7/pass.",
      "There will be an AED15% additional service charge on top of traffic fine charges and AED1/- on top of each Salik charge.",
    ],
  },
  {
  ...
  {
    heading: "8. Vehicle Offhire or Check-In Policy: - \"Condition & Non-smoking\":",
    text: [
      "The Hirer must keep the hired vehicle in a clean, safe, and sound condition. Otherwise charges may be applied.",
      "Smoking is prohibited inside Injaz Rent A Car Vehicles and offenders will be charged AED300/- against violating the same.",
      "Hirer must inform Injaz Rent A Car of his intention to return the vehicle at another premise or other Emirate, and must define the date and time otherwise excess days would be charged to him.",
  ...
  },
  {
    ...
    text: [
      "Any driver, of age above 25 years, holding an accepted and valid driving license of at least 1 year old, is entitled to drive our vehicle/s, under full insurance coverage, where the maximum accepted age for a driver is 75years old subject to being physically fit to drive.",
      ...
      "National Driving License is accepted from visitors who are citizens of these countries (UK, USA, FRANCE, JAPAN, BELGIUM, HOLAND, SWITZERLAND, DENMARK, GERMANY, ITALY, SWEDEN, GREECE, AUSTRIA, IRELAND, SPAIN, NORWAY, TURKEY, CANADA, POLAND, SOUTH KOREA, FINLAND, SOUTH AFRICA, AUSTRALIA, NEWZEALAND, ROMANIA, SINGAPORE, HONG KONG, PORTUGAL, LUXEMBOURG, SLOVENIA, LATVIA, LITUANIA, CHINA & HUNGARY).",
      "International Driving license is a must for visitors who are citizens of other countries that excluded & are not-listed above. (As specified by UAE Traffic & License Authorities).",
  ...
  },
  {
    ...
    text: [
      "Debit cards & Credit Cards are accepted by Injaz Rent A Car as a mean of payment.",
  ...
  },
  {
    ...
    text: [
      "Delivery/Collection of vehicle is chargeable and varies according to the distance from/to Abu Dhabi down Town Office, at a minimum charge of Dhs.50/- each way.",
    ],
  },
  {
    heading: "12. Airport Surcharge:",
    text: [
      "Airport delivery charges of Dhs.100/- will be applicable per each way.",
    ],
  },
  {
    heading: "13. Breakdown Service:",
    text: [
      "We offer you a 24 hours breakdown service. Clients have to contact & collaborate with our fleet controller on Mobile # 050-9961569 to receive the help.",
    ],
  },
  {
  ...
  },
  {
    ...
    text: [
      "Our vehicles are not permitted to be driven outside UAE.",
    ],
  },
  {
    heading: "18. Non-Smoking Policy",
    text: [
      "Smoking is prohibited inside Injaz Rent A Car vehicles and offenders are responsible to pay a penalty charge of Dhs300/- to INJAZ RENT A CAR against violating the same.",
    ],
  },
  {
    ...
    text: [
      ...
      "Hirer commits that he/any additional driver will not drive the vehicle outside UAE except to OMAN subject to a pre-approval from Injaz Rent A Car. Hirer commits that he or any additional driver will not use the vehicle to transport commercial passengers or any materials/products that are prohibited by the UAE Laws.",
    ],
  },
  {
    heading: "20. Vehicle Check-out & Check-in: -",
    text: [
      "Injaz Rent A Car will conduct vehicle's check-out & check–in at the time of handing it over or receiving it, to ensure vehicle's condition and to mark the status of each rented vehicle.",
    ],
  },
  {
    ...
    text: [
      ...
      "Then you will be recorded in Injaz Rent A Car blacklisted customer's file and won't be able to receive any future service from Injaz Rent A Car worldwide.",
    ],
  },
  {
    heading: "22. Grace Period of a Rental:",
    text: [
      "Injaz Rent A Car offers you 59 minutes as a grace period after the 24 hours/day, then extra minutes / hours will be rounded up to a whole rental day/s.",
      "Rental Day = 24 hours.",
      "Rental Week = 7 days.",
