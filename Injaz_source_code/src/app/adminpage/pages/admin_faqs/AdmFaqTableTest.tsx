...
export default function AdmFaqTableTest() {
  ...
  const requestSearch = (searchedVal: string) => {
    ...
    const filteredRows = rows.filter((row1: any) => {
      return (
        row1.Question.toLowerCase().includes(searchedVal.toLowerCase()) ||
                      ...
                      <TableCell align="center">
                        <BorderColorIcon
                          ...
                          onClick={() => {
                            ...
                            router.push(
                              `/pages/adminAddNewFaq?verify=${row._id}`
                            );
                          }}
                        />
                        <DeleteIcon
                          ...
                          onClick={() => {
                            Swal.fire({
                              ...
                              if (result.isConfirmed) {
                                axios
                                  .delete(
                                    serverUrl + `/user/deleteFAQ/${row._id}`
                                  )
                                  .then((res) => {
                                    Swal.fire(
                                      "Deleted!",
